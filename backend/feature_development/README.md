...
A PostgreSQL server hosted on AWS was used as our database, where our downstream Flask App drew from to provide the frontend team with the data to be displayed on the final weather application. 
...
*as of 18/09/2025:*
we have set up a DB using AWS, and will be using a lambda function to run our scraping script lambda.py. 
this script will be scraping the NEA website for storm images. 
